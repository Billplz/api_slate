...
```shell
# Creates a Payout API collection
curl https://www.billplz.com/api/v5/mass_payment_instruction_collections \
  -u 73eb57f0-7d4e-42b9-a544-aeac6e4b0f81: \
  -d title="My First API Payout Collection"  \
  -d epoch=1656912458 \
  -d checksum="b38abbf75e7e761b8ebd70832cd3d3ddcdc31b5f762d4d6f16a4a49aa0b135cdc564542f9ab6d514e2176af05cd293837a7dab901f8e3cf158a8956bd97a1f76"
```
...
`POST https://www.billplz.com/api/v5/mass_payment_instruction_collections`
...
```shell
# Get a Payout API collection
curl -G https://www.billplz.com/api/v5/mass_payment_instruction_collections/4po8no8h \
  -u 73eb57f0-7d4e-42b9-a544-aeac6e4b0f81: \
  -d epoch=1656912458 \
  -d checksum="b38abbf75e7e761b8ebd70832cd3d3ddcdc31b5f762d4d6f16a4a49aa0b135cdc564542f9ab6d514e2176af05cd293837a7dab901f8e3cf158a8956bd97a1f76"
```
...
`GET https://www.billplz.com/api/v5/mass_payment_instruction_collections/{PAYOUT_COLLECTION_ID}`
...
```shell
# Creates a Payout API for RM 20.00
curl https://www.billplz.com/api/v5/mass_payment_instructions \
  -u 73eb57f0-7d4e-42b9-a544-aeac6e4b0f81: \
  -d mass_payment_instruction_collection_id="4po8no8h" \
  -d bank_code="MBBEMYKL" \
  -d bank_account_number="820808062202123" \
...
`POST https://www.billplz.com/api/v5/mass_payment_instructions`
...
```shell
# Get a Payout API
curl -G https://www.billplz.com/api/v5/mass_payment_instructions/afae4bqf \
  -u 73eb57f0-7d4e-42b9-a544-aeac6e4b0f81: \
  -d epoch=1656912458 \
  -d checksum="b38abbf75e7e761b8ebd70832cd3d3ddcdc31b5f762d4d6f16a4a49aa0b135cdc564542f9ab6d514e2176af05cd293837a7dab901f8e3cf158a8956bd97a1f76"
```
...
`GET https://www.billplz.com/api/v5/mass_payment_instructions/{PAYOUT_API_ID}`
...
```shell
# Cancel a Payout API
curl -X POST https://www.billplz.com/api/v5/mass_payment_instructions/57iofla8/cancel \
  -u 73eb57f0-7d4e-42b9-a544-aeac6e4b0f81: \
  -d epoch=1656912458 \
  -d checksum="b38abbf75e7e761b8ebd70832cd3d3ddcdc31b5f762d4d6f16a4a49aa0b135cdc564542f9ab6d514e2176af05cd293837a7dab901f8e3cf158a8956bd97a1f76"
```
...
`POST https://www.billplz.com/api/v5/mass_payment_instructions/{PAYOUT_API_ID}/cancel`
